        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="border-t border-slate-900 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-slate-600">
                ...
                <div class="flex flex-col md:flex-row items-center gap-2 md:gap-4">
                    <p>Dikembangkan dengan <span class="text-red-500">❤</span> oleh <span class="text-indigo-400 font-medium">Anton & Jack</span> Informatika UNMUL</p>
