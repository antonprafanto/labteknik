        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-2xl sm:rounded-2xl border border-gray-200 dark:border-gray-700">
            <div class="p-8 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 relative">
                ...
                <div class="flex items-center">
                    ...
                    <div>
                        <h2 class="text-2xl font-bold text-gray-900 dark:text-white tracking-tight">Ajukan Peminjaman Ruangan</h2>
                        <p class="text-base text-gray-700 dark:text-gray-300 mt-2 font-medium">Isi formulir untuk mengajukan peminjaman ruangan</p>
                    </div>
                </div>
            </div>
