        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-2xl sm:rounded-2xl border border-gray-200 dark:border-gray-700">
            ...
            <div class="p-8 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 relative">
                ...
                <div class="flex items-center">
                    ...
                    <div>
                        <h2 class="text-2xl font-bold text-gray-900 dark:text-white tracking-tight">{{ __('Edit Laboratory') }}</h2>
                        <p class="text-base text-gray-700 dark:text-gray-300 mt-2 font-medium">{{ __('Update laboratory information.') }}</p>
                    </div>
                </div>
            </div>
            ...
            <form wire:submit.prevent="save" class="p-8 bg-white dark:bg-gray-800">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="space-y-2">
                        ...
                        <input wire:model="name" type="text" class="w-full px-4 py-3 bg-white border-2 border-gray-300 dark:border-gray-600 dark:bg-gray-900 text-gray-900 dark:text-white rounded-xl focus:border-indigo-500 focus:ring-indigo-500 shadow-sm transition-all duration-200 placeholder-gray-400 font-medium" />
                    ...
                    <div class="space-y-2">
                        ...
                        <input wire:model="location" type="text" class="w-full px-4 py-3 bg-white border-2 border-gray-300 dark:border-gray-600 dark:bg-gray-900 text-gray-900 dark:text-white rounded-xl focus:border-indigo-500 focus:ring-indigo-500 shadow-sm transition-all duration-200 placeholder-gray-400 font-medium" />
                    ...
                    <div class="space-y-2">
                        ...
                        <input wire:model="room_number" type="text" class="w-full px-4 py-3 bg-white border-2 border-gray-300 dark:border-gray-600 dark:bg-gray-900 text-gray-900 dark:text-white rounded-xl focus:border-indigo-500 focus:ring-indigo-500 shadow-sm transition-all duration-200 placeholder-gray-400 font-medium" />
                    ...
                    <div class="space-y-2">
                        ...
                        <input wire:model="capacity" type="number" class="w-full px-4 py-3 bg-white border-2 border-gray-300 dark:border-gray-600 dark:bg-gray-900 text-gray-900 dark:text-white rounded-xl focus:border-indigo-500 focus:ring-indigo-500 shadow-sm transition-all duration-200 placeholder-gray-400 font-medium" />
                    ...
                    <div class="space-y-2">
                        ...
                        <input wire:model="area" type="number" step="0.01" class="w-full px-4 py-3 bg-white border-2 border-gray-300 dark:border-gray-600 dark:bg-gray-900 text-gray-900 dark:text-white rounded-xl focus:border-indigo-500 focus:ring-indigo-500 shadow-sm transition-all duration-200 placeholder-gray-400 font-medium" />
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <select wire:model="head_lab_id" class="w-full px-4 py-3 bg-white border-2 border-gray-300 dark:border-gray-600 dark:bg-gray-900 text-gray-900 dark:text-white rounded-xl focus:border-indigo-500 focus:ring-indigo-500 shadow-sm transition-all duration-200 appearance-none font-medium">
                                <option value="" class="text-gray-900 mb-1">{{ __('Select Head of Lab') }}</option>
                                @foreach($heads as $head)
                                    <option value="{{ $head->id }}" class="text-gray-900">{{ $head->name }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <select wire:model="status" class="w-full px-4 py-3 bg-white border-2 border-gray-300 dark:border-gray-600 dark:bg-gray-900 text-gray-900 dark:text-white rounded-xl focus:border-indigo-500 focus:ring-indigo-500 shadow-sm transition-all duration-200 appearance-none font-medium">
                                <option value="aktif" class="text-gray-900">{{ __('Active') }}</option>
                                <option value="maintenance" class="text-gray-900">{{ __('Maintenance') }}</option>
                                <option value="tidak_aktif" class="text-gray-900">{{ __('Inactive') }}</option>
                            </select>
                            <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-4 text-gray-900 dark:text-white">
                                <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd" /></svg>
                            </div>
                    ...
                    <div class="space-y-2">
                        ...
                        @if($current_floor_plan)
                            <div class="mt-2 text-sm text-gray-500 dark:text-gray-400 flex items-center">
                                ...
                                {{ __('Current') }}: <a href="{{ asset('storage/' . $current_floor_plan) }}" target="_blank" class="ml-1 text-indigo-600 dark:text-indigo-400 hover:underline font-medium">{{ __('View') }}</a>
                            </div>
                        @endif
