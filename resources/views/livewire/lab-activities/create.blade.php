<div class="py-12 bg-gray-50 dark:bg-gray-900 min-h-screen">
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="mb-8 flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Tambah Kegiatan</h1>
                <p class="text-gray-600 dark:text-gray-400">Upload dokumentasi kegiatan laboratorium</p>
            </div>
        ...
        <form wire:submit="save" class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
            <div class="p-6 space-y-6">
                ...
                <!-- Photo Upload -->
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Foto Kegiatan <span class="text-red-500">*</span></label>
                    <div class="mt-1">
                        @if($photo)
