<div class="py-12 bg-gray-50 dark:bg-gray-900 min-h-screen">
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="mb-8 flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900 dark:text-white">QR Code Check-In</h1>
                <p class="text-gray-600 dark:text-gray-400">Generate QR code untuk check-in per laboratorium</p>
            </div>
            <a href="{{ route('lab-visits.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-800 dark:text-gray-200 font-medium rounded-xl transition-colors">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
                @if($selectedLab && $qrCode)
                    <div class="text-center">
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400 mb-6">Scan QR untuk check-in</p>
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-4 mb-6">
                            <p class="text-xs text-gray-500 dark:text-gray-400 break-all">
                                {{ route('lab-visits.check-in', ['laboratory' => $selectedLab->id]) }}
                            </p>
                        </div>
