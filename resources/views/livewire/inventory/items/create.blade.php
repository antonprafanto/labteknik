        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-2xl sm:rounded-2xl border border-gray-200 dark:border-gray-700">
            ...
            <div class="p-8 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 relative">
                ...
                <div class="flex items-center">
                    ...
                    <div>
                        <h2 class="text-2xl font-bold text-gray-900 dark:text-white tracking-tight">{{ __('Add New Inventory Item') }}</h2>
                        <p class="text-base text-gray-700 dark:text-gray-300 mt-2 font-medium">{{ __('Register a new item to the laboratory inventory.') }}</p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div class="space-y-2 md:col-span-2" x-data="{
                            ...
                            <div x-show="mode === 'upload'" x-transition>
                                ...
                                @if($image)
                                <div class="mt-3">
                                    <img src="{{ $image->temporaryUrl() }}" alt="Preview" class="w-40 h-40 object-cover rounded-xl border-2 border-gray-200 dark:border-gray-600">
                                </div>
                                @endif
                            </div>
