        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-2xl sm:rounded-2xl border border-gray-200 dark:border-gray-700">
            ...
            <div class="p-8 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 relative">
                ...
                <div class="flex items-center">
                    ...
                    <div>
                        <h2 class="text-2xl font-bold text-gray-900 dark:text-white tracking-tight">{{ __('Edit Schedule') }}</h2>
                        <p class="text-base text-gray-700 dark:text-gray-300 mt-2 font-medium">{{ __('Modify the practicum session details.') }}</p>
                    </div>
                </div>
            </div>

            <form wire:submit.prevent="update" class="p-8 bg-white dark:bg-gray-800">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <!-- Nama Pengajar/PIC -->
                    <div>
                        <label for="lecturer_name" class="block font-bold text-sm text-gray-900 dark:text-white mb-2">{{ __('Nama Pengajar/PIC') }}</label>
                        <input type="text" id="lecturer_name" wire:model="lecturer_name" placeholder="{{ __('Masukkan nama pengajar atau PIC') }}" class="w-full px-4 py-3 bg-white border-2 border-gray-300 dark:border-gray-600 dark:bg-gray-900 text-gray-900 dark:text-white rounded-xl focus:border-indigo-500 focus:ring-indigo-500 shadow-sm transition-all duration-200 placeholder-gray-400 font-medium">
                        @error('lecturer_name') <span class="flex items-center text-red-600 dark:text-red-400 text-sm mt-1 font-medium">{{ $message }}</span> @enderror
                    </div>
                    ...
                    <!-- Status -->
                    <div>
                        <label for="status" class="block font-bold text-sm text-gray-900 dark:text-white mb-2">{{ __('Status') }}</label>
                        <select id="status" wire:model="status" class="w-full px-4 py-3 bg-white border-2 border-gray-300 dark:border-gray-600 dark:bg-gray-900 text-gray-900 dark:text-white rounded-xl focus:border-indigo-500 focus:ring-indigo-500 shadow-sm transition-all duration-200 font-medium">
